Scriptname MantellaNpcSourceListenerScript extends ReferenceAlias  
...
Event OnSpellCast(Form akSpell)
    ...
    if spellCast
        ...
        MiscUtil.WriteToFile("mantella\\" + "_mantella_in_game_events.txt", selfName+" casted the spell " + spellCast + ".\n")
    endIf
endEvent
...
Event OnHit(ObjectReference akAggressor, Form akSource, Projectile akProjectile, bool abPowerAttack, bool abSneakAttack, bool abBashAttack, bool abHitBlocked)
    ...
    if ((hitSource != lastHitSource) && (aggressor != lastAggressor)) || (timesHitSameAggressorSource > 5)
        ...
        if (hitSource == "None") || (hitSource == "")
            ...
            MiscUtil.WriteToFile("mantella\\" + "_mantella_in_game_events.txt", aggressor + " punched "+selfName+".\n")
        elseif hitSource == "Mantella"
            ...
            MiscUtil.WriteToFile("mantella\\" + "_mantella_in_game_events.txt", aggressor + " hit "+selfName+" with " + hitSource+".\n")
        endIf
    else
...
Event OnCombatStateChanged(Actor akTarget, int aeCombatState)
    ...
    if (aeCombatState == 0)
        ...
        MiscUtil.WriteToFile("mantella\\" + "_mantella_in_game_events.txt", selfName+" is no longer in combat.\n")
    elseif (aeCombatState == 1)
        ;Debug.MessageBox(selfName+" has entered combat with "+targetName)
        MiscUtil.WriteToFile("mantella\\" + "_mantella_in_game_events.txt", selfName+" has entered combat with "+targetName+".\n")
    elseif (aeCombatState == 2)
        ;Debug.MessageBox(selfName+" is searching for "+targetName)
        MiscUtil.WriteToFile("mantella\\" + "_mantella_in_game_events.txt", selfName+" is searching for "+targetName+".\n")
    endIf
endEvent
...
Event OnObjectEquipped(Form akBaseObject, ObjectReference akReference)
    ...
    MiscUtil.WriteToFile("mantella\\" + "_mantella_in_game_events.txt", selfName+" equipped " + itemEquipped + ".\n")
endEvent
...
Event OnObjectUnequipped(Form akBaseObject, ObjectReference akReference)
    ...
    MiscUtil.WriteToFile("mantella\\" + "_mantella_in_game_events.txt", selfName+" unequipped " + itemUnequipped + ".\n")
endEvent
...
Event OnSit(ObjectReference akFurniture)
    ...
    MiscUtil.WriteToFile("mantella\\" + "_mantella_in_game_events.txt", selfName+" sat down.\n")
endEvent
...
Event OnGetUp(ObjectReference akFurniture)
    ...
    MiscUtil.WriteToFile("mantella\\" + "_mantella_in_game_events.txt", selfName+" stood up.\n")
EndEvent
